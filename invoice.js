...
(function() {
    ...
    async function clearInvoice() {
        if (currentInvoiceItems.length === 0 && !customerNameInput.value && !customerAddressInput.value && !customerEmailInput.value) {
    ...
    function generateInvoicePdf() {
        ...
        const cashierName = businessSettings.cashierName || 'N/A'; // From settings
        const businessLogo = businessSettings.businessLogo || '';
        ...
        drawHeaderWithLogoAndInfo(doc, yPos, (updatedYPos) => {
            ...
            // Notes/Payment Terms
            doc.setFontSize(10);
            doc.text(`Cashier: ${cashierName}`, 10, yPos); // Display cashier name
            yPos += 5;
